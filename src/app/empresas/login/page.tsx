...
function EmpresaLoginForm() {
  ...
  const from = searchParams.get("from") ?? "/empresa";
    ...
    <section className="py-24">
      <div className="container-page">
        <div className="mx-auto max-w-md">
          ...
          <p className="mt-3 text-sm text-ink-soft">Aceda ao Portal da Empresa para gerir as suas turmas.</p>
          ...
          <p className="mt-2 text-sm text-ink-soft">
            Ainda não tem conta?{" "}
            <Link href="/empresas/registo" className="text-gold-dark underline">
              Criar conta
            </Link>
          </p>
        </div>
