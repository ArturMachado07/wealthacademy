...
// Mesmo comportamento do sino da Área do Aluno (src/components/aluno/
// NotificationBell.tsx), só que a apontar para os endpoints do Admin —
// avisa a equipa quando um aluno confirma um pagamento ou termina um curso,
// sem terem de ir conferir o dashboard a toda a hora.
export default function AdminNotificationBell() {
  ...
  async function handleOpen() {
    ...
    if (next && unreadCount > 0) {
      ...
      fetch("/api/admin/notificacoes/marcar-lidas", { method: "POST" }).catch(() => null);
    }
  }
